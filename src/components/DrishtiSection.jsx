      ...
      <div className="drishti-grid">
        ...
        <div className="glass-panel drishti-card" data-aos="fade-right" data-aos-delay="100">
          ...
          <div className="drishti-card-content">
            <a href="https://discover.snaptiqz.com/organization/drishti-cet" target="_blank" rel="noopener noreferrer" className="btn-primary drishti-btn">Register Now</a>
        ...
        {/* Robosoccer Card */}
        <div className="glass-panel drishti-card" data-aos="fade-left" data-aos-delay="200">
          <div className="drishti-card-image-wrap">
